...
class CodegenCoreneuronCppVisitor: public CodegenCppVisitor {
  ...
  protected:
    ...
    /**
     * Print default values for range parameters registered by _mod_reg().
     */
    void print_global_param_default_values();


    /**
     * Print aliases used by generated mechanism registration metadata callbacks.
     */
    void print_mechanism_registration_helpers();
