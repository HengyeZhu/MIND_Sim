...
struct Memb_func {
    ...
    Memb_func() = default;
    Memb_func(const Memb_func&) = delete;
    Memb_func& operator=(const Memb_func&) = delete;
    Memb_func(Memb_func&& other) noexcept
        : alloc(other.alloc),
          ...
          private_constructor(other.private_constructor),
          private_destructor(other.private_destructor),
          sym(other.sym),
          vectorized(other.vectorized),
          thread_size_(other.thread_size_),
          thread_mem_init_(other.thread_mem_init_),
          thread_cleanup_(other.thread_cleanup_),
          thread_table_check_(other.thread_table_check_),
          is_point(other.is_point),
          setdata_(other.setdata_),
          dparam_semantics(other.dparam_semantics) {
        other.sym = nullptr;
        other.dparam_semantics = nullptr;
    }
...
extern void hoc_register_parm_default(int, const std::vector<double>*);
...
extern void mind_register_global_scalar(int type, const char* field_name, const char* hoc_name, double* value);
